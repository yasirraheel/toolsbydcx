          ...
          <div className="landing-hero-actions">
            ...
            {currentUser ? (
              <button type="button" className="landing-btn-secondary hero-cta-secondary" onClick={handleDownloadExtension}>
                ...
                Download Extension v{extensionInfo?.latest_version || '1.0.0'}
              </button>
            ) : (
            ...
            <div style={{ display: "flex", gap: "12px", flexWrap: "wrap", alignItems: "center" }}>
              {currentUser ? (
                <>
                  ...
                  <div style={{ fontSize: "13px", color: "#4ade80", width: "100%", marginTop: "4px" }}>
                    ✓ Logged in as {currentUser.email} • Click to download your extension package.
                  </div>
                </>
              ) : (
                <>
                  ...
                  >
                    ...
                    Sign In to Access Extension
                  </button>
                  <div style={{ fontSize: "13px", color: "#94a3b8", width: "100%", marginTop: "4px" }}>
                    🔒 Extension download is available exclusively to authenticated accounts.
                  </div>
                </>
              )}
            </div>
